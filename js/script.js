...
const displayContactList = function (data) {
    for (const student of data) {
        if (student.registered === "no") { //No need to create variables for students' names and registration statuses since you can access them easily using a dot notation and they're used once only.
